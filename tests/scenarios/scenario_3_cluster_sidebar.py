"""
Scenario 3: Cluster sidebar test

Load page, wait for interactive marker, click it, verify popup appears,
then click cluster-sidebar-button and verify sidebar appears.
"""
...
async def run(page: Page, log) -> bool:
    """Run the cluster sidebar scenario. Returns True if successful."""
    try:
        ...
        # Click the cluster-sidebar-button
        ...
        log("Sidebar appeared - test successful!")
